...
md(["### 6e. Classifier Evaluation\n",
    "\n",
    "To check if the model actually works, we need to test it on purchases it has **never seen**.\n",
    "\n",
    "We already have a natural way to do this because the dataset covers a full year.\n",
    "The model was trained on each customer's purchase history from **before November 2011**.\n",
    "We then ask: does it correctly predict which categories those customers bought from\n",
    "in **November and December 2011**?\n",
    "\n",
    "Because those November–December purchases were never used during training, this is a fair,\n",
    "honest test. It works the same way as real life — the model learns from past behaviour\n",
    "and is judged on future behaviour it has not seen.\n",
    "\n",
    "This is called a **temporal split**: features come from one time period, labels come from another.\n",
    "It avoids the problem where a random split could accidentally put a customer's future purchases\n",
    "into the training set and make the results look better than they really are.\n"]),

code([
    "from sklearn.metrics import classification_report, multilabel_confusion_matrix\n",
    "import seaborn as sns\n",
    "\n",
    "# Build evaluation arrays directly from the temporal split\n",
    "# Features : pre-November stats already stored in train_stats\n",
    "# Labels   : November-December purchases stored in test_cats_per_customer\n",
    ...
    "\n",
    "print(f'Customers evaluated : {len(Y_eval)}')\n",
    "print(f'Features from       : before November 2011 (training period)')\n",
    "print(f'Labels from         : November-December 2011 (never seen during training)')\n",
]),
...
md(["### 6f. Feature Importance — What Drives the Predictions?\n",
    "\n",
...
md(["### How a Recommendation is Made — Step by Step\n",
    "\n",
...
code([
    ...
    "    print(f'  {p[\"product\"][:48]:<48} similarity={p[\"score\"]:.4f}')\n",
]),
